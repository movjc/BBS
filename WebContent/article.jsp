...
<%@page import="java.sql.*,java.io.*,com.jc.bbs.*,java.util.*"%>
<%!
              ...
              <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                ...
                %>
                  ...
                  <tr class="jive-even">
                    ...
                    <td class="jive-author" nowrap="nowrap" width="1%"><span class=""> <a href="http://bbs.chinajavaworld.com/profile.jspa?userID=226030">jc</a> </span></td>
                    <td class="jive-view-count" width="1%"> 10400</td>
                    ...
                    <td class="jive-last" nowrap="nowrap" width="1%"><div class="jive-last-post"> <%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(a.getPdate()) %> <br>
                        by: <a href="http://bbs.chinajavaworld.com/thread.jspa?messageID=780182#780182" title="jingjiangjun" style="">jc &#187;</a> </div></td>
                  </tr>
                  <%-- 
                  <tr class="jive-odd">
                    <td class="jive-first" nowrap="nowrap" width="1%"><div class="jive-bullet"> <img src="images/read-16x16.gif" alt="已读" border="0" height="16" width="16">
